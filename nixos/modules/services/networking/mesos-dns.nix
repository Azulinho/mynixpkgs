  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.mesos-dns = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.mesos-dns}/bin/mesos-dns --config ${configFile}";
      };


    };

    environment.systemPackages = [ pkgs.mesos-dns ];
  };
